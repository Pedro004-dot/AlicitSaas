...
export const config = {
  // URL base da API - vem da variável de ambiente ou fallback para produção no Railway
  API_BASE_URL: process.env.REACT_APP_API_BASE_URL || 'https://alicitsaas-production.up.railway.app/api',
